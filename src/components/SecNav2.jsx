...
const SecNav2 = () => {
    const [sticky, setSticky] = useState(false);
      ...
      useEffect(() => {
          const onScroll = () => {
              setSticky(window.scrollY > 1180 && window.scrollY<4675 ); // toggle at 100px
          };
  ...
  return (
    <>
    <div ></div>
      <div className= {`${sticky ? 'fixed top-[126px] left-0 right-0 shadow-md  z-50' : 'relative'} 
                   border-2   py-1 justify-center bg-[#4d2b15]   transition-all duration-500 z-50 sm:grid sm:grid-cols-[20px_1fr_20px] gap-0   
                  `}>
        <div className=" min-h-6  bg-[#231b17]"></div>
        <div className=" min-h-30  border-2    py-1  text-[10px] md:text-[15px] text-center items-center">
          <div className="grid  grid-cols-12  min-h-30 ">
